    ...
    >
      ...
      <main>
        <div className="bg-[url('/assets/bg1.png')] bg-cover">
          ...
          <Features />
          <div className="h-[40vh] md:h-[80vh] px-8 flex items-center justify-center md:justify-start">
            <div className="relative text-white/70 text-center md:text-left space-y-8 md:space-y-10 px-2 xxs:px-4 md:ml-[10vw]">
              <h2 className="md:w-[40vw] text-3xl sm:text-4xl lg:text-6xl font-black leading-tight">
                NUMEROUS PLAYER&nbsp;
                <span className="font-cursive text-light-green">
                  projections
                </span>
              </h2>
              <p className=" md:w-[40vw] 4xl:w-[30vw] max-md:mx-auto">
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="hidden md:block absolute top-1/2 -right-[50%] translate-y-1/2"
              >
                <path
        ...
        <Players />
        <div className="bg-[url('/assets/bg2.png')] bg-cover min-h-[100vh]">
          <WhyUs />
        </div>
      </main>
    </motion.div>
